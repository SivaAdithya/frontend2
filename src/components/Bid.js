...
export default function Bid()
{
    ...
    const getDet = async()=>
    {
        ...
        const url = "https://server1-two.vercel.app/backend/get_det/"+id;
    ...
    const cr_req = async() => {
        ...
        const url_cr = "https://server1-two.vercel.app/backend/create-cart/";
    ...
    const Ong_set = async() => {
        ...
        try{
            ...
            const url = "https://server1-two.vercel.app/backend/getauc/"+dat.id;
    ...
    const Comp_set = async() => {
        ...
        try{
            ...
            const url2 = "https://server1-two.vercel.app/backend/getauc/"+dat.id;
 ...
 let tim = new Date(dat.time);
   ...
   const handleClick = async() =>{
    ...
    const url_amt = "https://server1-two.vercel.app/backend/get_amt/"+id;
    ...
    {
        const url_upd_amt = "https://server1-two.vercel.app/backend/upd-amt/"+id;
